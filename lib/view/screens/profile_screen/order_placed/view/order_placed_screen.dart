                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          final deliveryDate = ordersController.formatDate(
                              ordersController.ordersList![index].deliveryDate
                                  .toString());
                          final canceledDate =
                              ordersController.formatCancelDate(ordersController
                              ...
                              return GestureDetector(
                                onTap: () {
                                  Get.to(OrderDetialsView(
                                    orderId:
                                        ordersController.ordersList![index].id,
                                    index1: index1,
                                  ));
                                },
                                child: Row(
                                    ...
                                    SizedBox(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            ordersController.ordersList![index1]
                                                        .orderStatus ==
                                                    'CANCELED'
                        ...
                        itemCount: ordersController.ordersList?.length ?? 0,
                      ),
                    );
        },
      ),
